...
export type KycliConfig<Dialect extends KyselyDialect = KyselyDialect> = {
...
export interface ResolvedKycliConfig {
    args: GetConfigArgs;
    configMetadata: {
        configFile?: string;
    };
...
export interface ResolvedKycliConfigWithKyselyInstance extends Omit<ResolvedKycliConfig, 'kysely'> {
    kysely: Kysely<any>;
}
