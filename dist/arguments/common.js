...
export const CommonArgs = defineArgs({
    ...
    environment: {
        alias: 'e',
        description: 'Load .env and .env.<environment> before reading the configuration.',
        type: 'string',
    ...
    'no-outdated-check': {
        default: false,
        description: 'Will not check for latest kysely/kycli versions and notice newer versions exist.',
        type: 'boolean',
    },
    version: {
        alias: 'v',
