export declare const GenTypesCommand: {
    readonly "gen:types": Readonly<Omit<import("citty").CommandDef<{
        readonly source: {
            readonly description: "Generate types from migrations or the live database.";
