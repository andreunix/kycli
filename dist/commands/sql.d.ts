export declare const SqlCommand: {
    readonly sql: Readonly<Omit<import("citty").CommandDef<{
        readonly format: {
            readonly alias: "f";
            readonly default: "csv";
            readonly description: "The format to output the result in.";
            readonly options: ["csv", "json"];
            readonly required: false;
            readonly type: "enum";
        };
        readonly query: {
            readonly description: "The SQL query to execute. When not provided, and not in CI, will open an interactive SQL shell.";
            readonly required: boolean;
            readonly type: "positional";
        };
        readonly 'no-outdated-check': {
            readonly default: false;
            readonly description: "Will not check for latest kysely/kycli versions and notice newer versions exist.";
