export declare const RunCommand: {
    readonly run: Readonly<Omit<import("citty").CommandDef<{
        readonly specific: {
            readonly description: "Run seed file/s with given name/s";
...
export declare const LegacyRunCommand: {
    readonly "seed:run": Readonly<Omit<import("citty").CommandDef<{
        readonly specific: {
            readonly description: "Run seed file/s with given name/s";
            readonly type: "string";
        };
