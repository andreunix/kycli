export declare const MakeCommand: {
    readonly make: Readonly<Omit<import("citty").CommandDef<{
        readonly seed_name: {
            readonly description: "Seed file name to create";
...
export declare const LegacyMakeCommand: {
    readonly "seed:make": Readonly<Omit<import("citty").CommandDef<{
        readonly seed_name: {
            readonly description: "Seed file name to create";
            readonly required: true;
            readonly type: "positional";
