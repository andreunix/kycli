export declare const RollbackCommand: {
    readonly rollback: Readonly<Omit<import("citty").CommandDef<{
        readonly all: {
            readonly description: "Rollback all completed migrations";
...
export declare const LegacyRollbackCommand: {
    readonly "migrate:rollback": Readonly<Omit<import("citty").CommandDef<{
        readonly all: {
            readonly description: "Rollback all completed migrations";
            readonly required: true;
            readonly type: "boolean";
