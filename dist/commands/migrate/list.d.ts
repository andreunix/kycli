export declare const ListCommand: {
    readonly list: Readonly<Omit<import("citty").CommandDef<{
        readonly 'fail-on-pending': {
            readonly default: false;
            readonly description: "Fail if there are pending migrations";
...
export declare const LegacyListCommand: {
    readonly "migrate:list": Readonly<Omit<import("citty").CommandDef<{
        readonly 'fail-on-pending': {
            readonly default: false;
            readonly description: "Fail if there are pending migrations";
            readonly type: "boolean";
