export declare const LatestCommand: {
    readonly latest: Readonly<Omit<import("citty").CommandDef<{
...
export declare const LegacyLatestCommand: {
    readonly "migrate:latest": Readonly<Omit<import("citty").CommandDef<{
        readonly 'no-transaction': {
            readonly description: "Don't use a transaction when running the migrations. This will not work for now if you've provided your own Migrator factory.";
            readonly type: "boolean";
        };
