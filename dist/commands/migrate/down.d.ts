export declare const DownCommand: {
    readonly down: Readonly<Omit<import("citty").CommandDef<{
...
export declare const LegacyDownCommand: {
    readonly "migrate:down": Readonly<Omit<import("citty").CommandDef<{
        readonly migration_name: {
            readonly description: "Migration name to run/undo.";
            readonly required: boolean;
            readonly type: "positional";
